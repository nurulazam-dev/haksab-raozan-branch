...
export const addIncome = createAsyncThunk('finance/addIncome', async (incomeData) => {
    const response = await financeService.addIncome(incomeData);
    return response.data;
});

export const addExpense = createAsyncThunk('finance/addExpense', async (expenseData) => {
